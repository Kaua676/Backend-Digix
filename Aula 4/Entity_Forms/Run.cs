...
namespace Entity_Forms
{
    ...
    public class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            this.BackgroundImage = Image.FromFile(@"C:\Users\kauavicente\Documents\Aulas C#\Backend-Digix\Aula 4\Entity_Forms\gato.jpg");
    ...
    public class MaquinaCrud : Form
    {
        ...
        public MaquinaCrud()
        {
            ...
            // Remove a cor de fundo sólida, pois agora estamos utilizando uma imagem
            this.ForeColor = ColorTranslator.FromHtml("#CDCDCD");
            ...
            // Função para centralizar o ListBox
            // Certifique-se de que os métodos não estão dentro de outros métodos ou construtores
            void CentralizarListBox()
            {
                listBoxMaquinas.Location = new Point((this.Width - listBoxMaquinas.Width) / 2, 200);
            }

            // Evento para atualizar a posição ao redimensionar o formulário
            // Também fora de outros métodos
